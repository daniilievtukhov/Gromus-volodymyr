...
import InsIcon from '../assets/icons/mingcute_ins-fill.svg';
import SpotifyIcon from '../assets/icons/mingcute_spotify-fill.svg';

import { btnDescription, subscribePackageBtn, separator } from "../pages/pricing/Pricing";
		...
		<Row style={footerStyle} className="d-flex justify-content-center px-5">
			...
			<Col className="col-lg-4 col-md-4 col-sm-7 col-xs-10 mb-4">
				<Container>
					...
					<label className="text-white py-3 w-100" style={btnDescription}>Sparks of inspiration are in every note. </label>
				</Container>
			...
			<Col className="text-center col-lg-4 col-md-4 col-sm-7 col-xs-10 mb-4">
				...
				<a className="m-3" style={footerLink}>Work with us as an artist</a>
				<Button className='text-black px-5 py-2' style={subscribePackageBtn}>SUBMIT</Button>
			...
			<Row className="mb-5 text-white text-center">
				...
				<Col className="col-md-6 col-10">
					<label>Gromus, Inc is not affiliated with or endorsed by TikTok© Inc. or ByteDance© Ltd. <br />
						All product and company names are registered trademarks of their original owners</label>
				</Col>
