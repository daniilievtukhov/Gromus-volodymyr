...
export const Video = () => {
	...
	return (
		<Grid justify="center" style={{ backgroundColor: "#0D0D0E", overflowX: "hidden", overflowY: "hidden" }}>
			<Grid.Col style={{ backgroundColor: "#0D0D0E", overflowX: "hidden" }}>
				...
				<Grid justify="center" align="center" style={{ margin: "30px", backgroundColor: "#0D0D0E" }}>
