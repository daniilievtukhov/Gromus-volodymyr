import { Input, Button, Select, Flex, Text, Stack, Box, Overlay, Group, Code, Image, useCombobox, Combobox, ScrollArea, TextInput } from "@mantine/core";
...
const languages = [
  { group: "", items: [
    {label: "English", value: "English", countryCode: "EN", flagPath: "/app-assets/fonts/flag-icon-css/flags/4x3/gb.svg"},
    {label: "Spain", value: "Spain", countryCode: "ES", flagPath: "/app-assets/fonts/flag-icon-css/flags/4x3/es.svg"},
    {label: "Germany", value: "Germany", countryCode: "DE", flagPath: "/app-assets/fonts/flag-icon-css/flags/4x3/de.svg"},
    {label: "Ukrainian", value: "Ukrainian", countryCode: "UK", flagPath: "/app-assets/fonts/flag-icon-css/flags/4x3/ua.svg"},
  ]},
  { group: " ", items: [
    {label: "Russian", value: "Russian", countryCode: "RU", flagPath: "/app-assets/fonts/flag-icon-css/flags/4x3/ru.svg"},
  ]}
]
  ...
  return (
    <Flex gap={10}>
      ...
      <Input
        ...
        leftSectionWidth={110}
        leftSection={
          <Group gap="5px" p={"4.6px 14px 4.6px 6px"} m={"0px 10px 0px 0px"} style={{borderRight: "1.5px solid #3C3C3C", position: "absolute", top: 0}}>
