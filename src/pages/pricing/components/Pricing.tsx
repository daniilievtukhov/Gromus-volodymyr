...
const priceCards: IPriceCard[] = [
  {
    ...
    options: [
      ...
      { isAvalible: true, signedText: "3 times", text: "TikTok Any Account Insights", comingSoon: false },
...

  {
    ...
    isMonth: true,
    subscribeLink: "https://buy.stripe.com/test_9AQaGz3QIeUN2KkaEE",
    options: [
  ...
  },
  {
    ...
    subscribeLink: "https://buy.stripe.com/test_00g6qj72U9AtdoY4gh",
    isMonth: true,
    options: [ 
  ...
  return (
    ...
    >
      ...
      <Grid
        ...
        justify="center"
      >
        {priceCards.map(priceCard =><PriceCard priceCard={priceCard}/>)}
