...
export const PersonalizedHashtagsPage = () => {
  ...
  const { data, isSuccess } = useHashtagsAnalytics({Country: hashtagsFilter?.country, Category: hashtagsFilter?.category})

  
  return isSuccessHashtagsFilter && isSuccess && data && (
